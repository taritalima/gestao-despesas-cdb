...
import br.com.cdb.controledespesas.config.FiltroDespesasConfig;
...
public class DespesaUseCase implements DespesaInputPort {
    ...
    public List<Despesa> filtrarDespesas(FiltroDespesasRequest filtroDespesasRequest) {
        ...
        LocalDate de = filtroDespesasRequest.getDe() != null ? filtroDespesasRequest.getDe() : config.getDataInicioPadrao();
        LocalDate ate = filtroDespesasRequest.getAte() != null ? filtroDespesasRequest.getAte() : config.getDataFimPadrao();
